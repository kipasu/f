...
# xray config
wget -q -O /etc/xray/config.json "${REPO}xray/config.json"
...
#nginx config
wget -O /etc/nginx/conf.d/xray.conf "${REPO}ssh/xray.conf"
wget -O /etc/haproxy/haproxy.cfg "${REPO}ssh/haproxy.cfg"
